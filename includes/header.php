...
<html lang="en">
   ...
   <head>
      ...
      <title>EduSync</title>
      <link rel="shortcut icon" href="<?=urlOf("assets/img/favicon.png")?>">
      ...
      <div class="main-wrapper">
         <div class="header">
            <div class="header-left">
               <a class="logo">
               <img src="<?=urlOf("assets/img/logo.png")?>" alt="Logo">
               </a>
                        ...
                        <ul class="notification-list">
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    ...
                                    <img class="avatar-img rounded-circle" alt="User Image" src="<?=urlOf("assets/img/profiles/avatar-02.jpg")?>">
                                    </span>
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="<?=urlOf("assets/img/profiles/avatar-11.jpg")?>">
                                    </span>
                                    <div class="media-body">
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="<?=urlOf("assets/img/profiles/avatar-17.jpg")?>">
                                    </span>
                                    <div class="media-body">
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="<?=urlOf("assets/img/profiles/avatar-13.jpg")?>">
                                    </span>
                                    <div class="media-body">
